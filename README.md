#### QuickShop is a Complete Build of Laravel 5.4 with Email Registration Verification, Social Authentication, User Roles and Permissions, User Profiles, and Admin restricted user management system.

#### READY FOR USE!
- [About](#about)
- [Features](#features)
- [Installation Instructions](#installation-instructions)
    - [Rebuild Front End Assets with Mix [npm required, not used in quickshop] (optional)](#rebuild-front-end-assets-with-mix)
...
1. Run `sudo git clone https://dhirajpatra@bitbucket.org/dhirajpatra/quickshop.git`
