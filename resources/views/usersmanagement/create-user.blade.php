        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            {!! Form::open(array('action' => 'UsersManagementController@store', 'method' => 'POST', 'role' => 'form')) !!}
              ...
              <div class="form-group has-feedback row {{ $errors->has('store_plan') ? ' has-error ' : '' }}">
                  {!! Form::label('labelStorePlan', trans('forms.create_user_label_store_plan'), array('class' => 'col-md-3 control-label')); !!}
                  <div class="col-md-9">
                      <div class="input-group">
                          {!! Form::select('store_plan', $storePlans, '3', ['class' => 'form-control']) !!}
                          <label class="input-group-addon" for="name"><i class="fa fa-fw {{ trans('forms.create_user_icon_store_plan') }}" aria-hidden="true"></i></label>
                      </div>
                      @if ($errors->has('store_plan'))
                          <span class="help-block">
                        <strong>{{ $errors->first('store_plan') }}</strong>
                    </span>
                      @endif
                  </div>
              </div>
