                ...
                @role('admin')
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li {{ Request::is('stores','stores/' . Auth::user()->id, 'users/' . Auth::user()->id . '/edit') ? 'class=active' : null }}>{!! HTML::link(url('/users'), Lang::get('titles.adminUserList')) !!}</li>
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li {{ Request::is('store/'.Auth::user()->name, 'store/'.Auth::user()->name . '/edit') ? 'class=active' : null }}>
                                {!! HTML::link(url('/store/'.Auth::user()->name), trans('titles.store')) !!}
                            </li>
                            <li {{ Request::is('store/payment/'.Auth::user()->name, 'store/payment/'.Auth::user()->name ) ? 'class=active' : null }}>
                                {!! HTML::link(url('/store/payment/'.Auth::user()->name), trans('titles.payment')) !!}
                            </li>
                            <li>
                                <a href="{{ route('logout') }}"
