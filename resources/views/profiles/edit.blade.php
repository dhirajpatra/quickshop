									...
									<div class="tab-pane fade in active edit_profile">
										...
										{!! Form::model($user->profile, ['method' => 'PATCH', 'route' => ['profile.update', $user->name],  'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data'  ]) !!}
											...
											<div class="form-group has-feedback {{ $errors->has('phone') ? ' has-error ' : '' }}">
												{!! Form::label('phone', trans('profile.label-phone') , array('class' => 'col-sm-4 control-label')); !!}
												<div class="col-sm-6">
                                            ...
                                            <div class="form-group has-feedback {{ $errors->has('comapny') ? ' has-error ' : '' }}">
                                                {!! Form::label('company', trans('profile.label-company') , array('class' => 'col-sm-4 control-label')); !!}
                                                <div class="col-sm-6">
                                                    {!! Form::text('company', old('company'), array('id' => 'company', 'class' => 'form-control', 'placeholder' => trans('profile.ph-company'))) !!}
                                                    <span class="glyphicon glyphicon-pencil form-control-feedback" aria-hidden="true"></span>
